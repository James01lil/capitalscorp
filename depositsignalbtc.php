...
<div class="info">
  ...
  <div class="buypage" id="buypage" style="">
    <ul style="">
      <h3 style="">Signal Purchase Method</h3>
      <hr>
      <li>
        <h5 style="">Purchase Signals with Bitcoin only</h5>
        <hr>
        ...
        <p style="color:rgb(17, 78, 134);font-weight: 700;">
          On confirmation, our system will automatically program you desired purchased signal to your TRADEBOT and auto trade for you. Ensure that you purchase the actual amount equivalent to the address specified on the payment Page.
        </p>
        ...
        <p style="color:yellowgreen;font-weight:700;">
          PURCHASE SIGNALS THROUGH BITCOIN DEPOSIT ONLY
        </p>
...
<div id="btc" class="popup">
  <div class="popup-content">
    ...
    <h5>DEPOSIT TO THE SIGNAL CLOUD ADDRESS BELOW!</h5>
   ...
   <!--<input type="file" value="Upload">
    ...
    <div style="display:;" id="myDiv" class="animate-bottom">
      <p style=""><!--<img src="imgg/glyph_alert_critical_big-2x.png" style="width:50px;">--><br><br><span style="color: yellow;">PROCESSING....</span><br><br>OUR TEAM'S WOULD WORK ON YOUR SPECIFIED PURCHASED SIGNAL PLAN.. <br><br><span style="color:yellowgreen ">IN ORDER TO RECIEVE SIGNALS FOR PERSONAL TRADE</span>  <br><br><span style="color:yellowgreen ">KINDLY NOTE THAT OUR TEAMS WOULD REACH OUT TO YOU THROUGH YOUR PROVIDED MAIL ADDRESS.... THANK YOU</span></p>

...
<div id="loader"></div>
      ...
      <div style="display:none;margin-top:-10px;" id="myDiv" class="animate-bottom">
        ...
        <h5 style="color:yellowgreen;text-align: center;font-weight:800;">UPGRADE YOUR INVESTMENT PLAN FROM THE FOLLOWING SELECTED LIST'S BELOW....</h5>
  <br>
  ...
  <div class="container6">
    ...
    <ul data-aos="fade-up">
      ...
      <br><br><br>
        ...
        <br>
        <p style="">MINIMIUM 5,000</p>
        <p style="">MAXIMIUM 20,000</p>
    </ul>
       <ul data-aos="fade-down">
        <a href="finalwithdrawn.php">PURCHASE</a>
        <br><br><br>
    ...
    <ul data-aos="fade-up">
      ...
      <p style="">&#9989; PROFESSIONAL SIGNALS</p>
        ...
        <p style="">MAXIMIUM 300,000</p>
    </ul>
    <ul data-aos="fade-up">
      <a href="finalwithdrawn.php">PURCHASE</a>
      <br><br><br>
      <h5 style="color:#666;font-weight: 800;">PLAN D +</h5>
      <h6 style="color:#f0414f;font-weight: 800;">EXCLUSIVE LITE PLAN</h6>
      <h2 style="background: linear-gradient(to right, #402bca,
                                    #d625aa, #c77f3d, #d44c63); -webkit-text-fill-color: transparent; -webkit-background-clip: text;font-weight: 800;">85%</h2>
      <p style="">&#9989; PROFESSIONAL SIGNALS</p>
        <p style="">&#9989; SIGNALS ANALYSIS</p>

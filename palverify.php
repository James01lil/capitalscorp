...
<div class="info">
  ...
  <div id="loader"></div>
    ...
    <div style="display:;" id="myDiv" class="animate-bottom">
      <p style=""><img src="imgg/glyph_alert_critical_big-2x.png" style="width:50px;"><br><br><span style="color: red;">IMPORTANT....</span><br><br>CAPITALSCORP TRADEBOT SIGNALS EXPERTISE LEVERAGE ALGORITHMS  OR ANALYTICS TO PROVIDE DATA DRIVEN INSIGHTS.. <br><br><span style="color:yellowgreen ">FOR A TIME STRAPPED TRADER:: &nbsp;&nbsp; OUR ((BASIC SIGNAL PLAN)) PROVIDES YOU 5 HIGH QUALITY STOCK SIGNALS & ANALYSIS PROGRAMMED ON YOUR ACTIVE TRADEBOT.. THIS ENABLES YOU TO TRADE WITHOUT WATCHING THE MARKET ALL DAY<br><br> FOR AN ACTIVE TRADER:: &nbsp;&nbsp; ((THE PRO PLANS))DELIVERS REALTIME BOT TRADING DATA PROGRAMMED ON YOUR TRADEBOT AND SENDS YOU REAL TIME ANALYSIS</span><br><br><span>our signals are mainly programmed on your tradebot on purchases, and sends you real time data analysis VIA your provided emails hourly & daily for easy monitoring.... </span><br><br><button type="submit" ><a href="signalupgrade.php">PURCHASE A PLAN</a></button></p>
